...
require('lazy').setup({
  ...
  -- Use LSP to highlight current symbol.
...
lspconfig.bufls.setup {
  ...
  root_dir = function(startpath)
    return lspconfig.util.search_ancestors(startpath, function(path)
      if lspconfig.util.path.is_dir(path) and path:match('/proto$') then
        return path
      end
...
vim.keymap.set("n", "<leader>tf", require("neotest").run.run, { desc = "Test function" })
vim.keymap.set("n", "<leader>ts", require("neotest").summary.toggle, { desc = "Test summary" })
vim.keymap.set("n", "<leader>tw", require("neotest").watch.watch, { desc = "Watch test function" })
